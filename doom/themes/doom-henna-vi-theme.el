...
;; Vi's tinkering with it because markdown is nice
;;
...
(defgroup doom-henna-vi-theme nil
  "Options for the `doom-henna' theme."
  :group 'doom-themes)

(defcustom doom-henna-vi-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-henna-vi-theme
  :type 'boolean)

(defcustom doom-henna-vi-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-henna-vi-theme
  :type 'boolean)

(defcustom doom-henna-vi-comment-bg doom-henna-vi-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-henna-vi-theme
  :type 'boolean)

(defcustom doom-henna-vi-padded-modeline doom-themes-padded-modeline
...
(base0      '("#10151a" "black"   "black"        ))
   ...
   (-modeline-bright doom-henna-vi-brighter-modeline)
   (-modeline-pad
    (when doom-henna-vi-padded-modeline
  ...
  (((font-lock-comment-face &override)
    :background (if doom-henna-vi-comment-bg (doom-lighten bg 0.05)))
   ...
   (markdown-header-face-1         :foreground red :height 1.3  :weight 'extra-bold :inherit 'markdown-header-face)
   (markdown-header-face-2         :foreground teal :height 1.2 :weight 'extra-bold :inherit 'markdown-header-face)
   (markdown-header-face-3         :foreground green :height 1.1 :weight 'extra-bold :inherit 'markdown-header-face)
   (markdown-header-face-4         :foreground red :height 1.0 :weight 'bold :inherit 'markdown-header-face)
   (markdown-header-face-5         :foreground teal :height 1.0 :weight 'bold :inherit 'markdown-header-face)
   (markdown-header-face-6         :foreground green :height 1.0 :weight 'bold :inherit 'markdown-header-face)
   (markdown-header-delimiter-face :foreground red :weight 'bold :inherit 'markdown-header-face)
   (markdown-inline-code-face      :foreground teal :weight 'bold :inherit 'markdown-header-face)
   ;;;; outline <built-in>
...
;;; doom-henna-vi-theme.el ends here
