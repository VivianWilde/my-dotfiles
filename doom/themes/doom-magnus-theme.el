...
(def-doom-theme doom-magnus
  ...
  ((bg         '("#072017" nil       nil            ))
   ...
   (yellow     '("#9fcc2e" "#ECBE7B" "yellow"       )) ;; magnus, todo 16
...
;;;; solaire-mode
   ...
   ((outline-6 &override) :foreground (doom-darken yellow 0.2))
   ((outline-7 &override) :foreground (doom-darken dark-cyan 0.2))
   ((outline-8 &override) :foreground (doom-darken teal 0.2))
